...
export default function ComoTrabalhamos() {
    return(
        <>
            ...
            <div className="lg:flex lg:justify-evenly lg:gap-32">
                ...
                <div className="lg:hidden flex justify-end my-[-20px]">
                ...
                <div className="lg:hidden flex justify-end my-[-20px]">
                    <Image src={SetaBaixo} alt="Seta Baixo" className="w-26 rotate-90 lg:w-250 lg:rotate-0" />
                </div>
